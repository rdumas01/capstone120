...
class MoveItDrawStarDemo:
    ...
    def point_callback1(data):
        MoveItDrawStarDemo.point1 = [data.x, data.y, data.z]

    def point_callback2(data):
        MoveItDrawStarDemo.point2 = [data.x, data.y, data.z]
    
    
    def __init__(self):
        rospy.Subscriber('pointadd', Point, MoveItDrawStarDemo.point_callback1)
    #rospy.Subscriber('pointadd', Point, MoveItDrawStarDemo.point_callback2)
        # 初始化move_group的API
        ...
        #插入點
        # 插入點
    if MoveItDrawStarDemo.point1:
            points_list.insert(1, MoveItDrawStarDemo.point1)
            print("point list=", points_list)  # corrected variable name

        #if MoveItDrawStarDemo.point2:
            #points_list.insert(2, MoveItDrawStarDemo.point2)t
